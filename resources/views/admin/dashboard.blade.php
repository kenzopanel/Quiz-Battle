    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $quiz->category->name }} • {{ $quiz->questions_count }} soal
                                    </p>
                                </div>
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400">Belum ada kuis yang dibuat.</p>
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('admin.categories.create') }}"
                        class="flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700">
